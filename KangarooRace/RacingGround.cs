...
namespace KangarooRace
{
    public partial class RacingGround : Form
    {
        ...
        private void SetupRaceTrack()
        {
            ...
            punters[0] = pFactory.getPunter("Iqbal", MaximumBet, IqbalBet); //getting Iqbal object from factory class
            punters[1] = pFactory.getPunter("Raj", MaximumBet, RajBet); //getting Raj object from factory class
            punters[2] = pFactory.getPunter("Sukhdeep", MaximumBet, SukhdeepBet); //getting Sukhdeep object from factory class
